 ...
 */
    ...
    $translation['destination_path_not_dir']    = 'El path especificado no es un directorio. Imposible continuar.';
    ...
    $translation['source_not_readable']         = 'El archivo fuente es ilegible. Imposible continuar.';
    ...
    $translation['watermark_no_create_support'] = 'Creación desde un archivo %s imposible, la marca de agua no puede ser leído.';
    $translation['watermark_create_error']      = 'Error en el momento de la creación del la marca de agua %s desde el archivo fuente.';
    $translation['watermark_invalid']           = 'Imposible leer la marca de agua, formato de archivo desconocido.';
