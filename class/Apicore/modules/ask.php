  ...
  class ask extends Core {
    ...
    function plusTable($ID){
      $all = [
        ...
        'car_parts' => 'car_parts_class'
      ];
      $rel = [
        'car_brands' => 'brandID',
        'car_parts_class' => 'classID'
      ];
    ...
    function notilist($filter){
      ...
      $c2 = [
        'car_models.name(text)',
        'car_models.ID(value)',
        'car_brands.name(parent)',
        'car_brands.ID(parentID)'
      ];
      ...
      $c3 = [
        'car_parts.name(text)',
        'car_parts.ID(value)',
        'car_parts_class.name(parent)',
        'car_parts_class.ID(parentID)'
      ];
